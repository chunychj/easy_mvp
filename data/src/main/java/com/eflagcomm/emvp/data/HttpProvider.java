...
public class HttpProvider {
    ...
    private static HttpProvider sHttpProvider = null;
    ...
    private HttpProvider(String baseUrl, boolean isDebug, Context context) {
    ...
    public static HttpProvider createProvider(String baseUrl, boolean isDebug, Context context) {
        if (sHttpProvider == null) {
            synchronized (HttpProvider.class) {
                if (sHttpProvider == null) {
                    sHttpProvider = new HttpProvider(baseUrl, isDebug, context);
                }
            }
        }
