...
import com.eflagcomm.emvp.base.GlideApp;
...
public class ImageUtil {
     ...
     * @param url
     */
    public static void showRoundImage(Context context, ImageView img, String url) {
        GlideApp.with(context)
                .load(url)
     ...
     * @param url
     */
    public static void showTdRoundImage(Context context, ImageView img, String url) {
        GlideApp.with(context)
                .load(url)
                .placeholder(R.drawable.icon_tongue_placeholder)
                .transform(new RoundedCorners((int) context.getResources().getDimension(R.dimen.dp_10)))
                .into(img);
    }
